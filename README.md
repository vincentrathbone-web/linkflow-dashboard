...
[![Desktop](https://img.shields.io/badge/desktop-0.1.24-2563eb)](./linkflow-dashboard/README.md)
[![Plugin](https://img.shields.io/badge/WordPress%20plugin-0.4.36-21759b?logo=wordpress&logoColor=white)](./wordpress-plugin/linkflow-dashboard/README.md)
...
| --- | ---: | --- | --- |
| Windows desktop app | **0.1.24** | Live (GitHub Release) | `linkflow-dashboard/src-tauri/` |
| WordPress plugin | **0.4.36** | Live on `controll.co.za` | `wordpress-plugin/linkflow-dashboard/` |

...
[![Desktop](https://img.shields.io/badge/desktop-0.1.23-2563eb)](./linkflow-dashboard/README.md)
[![Plugin](https://img.shields.io/badge/WordPress%20plugin-0.4.34-21759b?logo=wordpress&logoColor=white)](./wordpress-plugin/linkflow-dashboard/README.md)
...
| --- | ---: | --- | --- |
| Windows desktop app | **0.1.23** | Live (GitHub Release) | `linkflow-dashboard/src-tauri/` |
| WordPress plugin | **0.4.34** | Live on `controll.co.za` | `wordpress-plugin/linkflow-dashboard/` |

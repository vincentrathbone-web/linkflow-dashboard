...
[![Desktop](https://img.shields.io/badge/desktop-0.1.22-2563eb)](./linkflow-dashboard/README.md)
...
| --- | ---: | --- | --- |
| Windows desktop app | **0.1.22** | Live (GitHub Release) | `linkflow-dashboard/src-tauri/` |
